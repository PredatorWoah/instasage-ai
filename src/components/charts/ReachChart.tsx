      ...
      <AreaChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: 0 }}>
        <defs>
          <linearGradient id="reachGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#3CC8E8" stopOpacity={0.25} />
            <stop offset="95%" stopColor="#3CC8E8" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <Area
          ...
          fill="url(#reachGrad)"
          connectNulls
          dot={{ r: 2.5, strokeWidth: 0, fill: '#3CC8E8' }}
          activeDot={{ r: 4, fill: '#3CC8E8' }}
        />
      </AreaChart>
    </ResponsiveContainer>
  );
